(function ($) {
    ...
    iMissU.prototype = {
                    ...
                    if (response.status === 'connected') {
                        ...
                        $(document).ready(function () {
                            ...
                            $(".etabs a").click(function (e) {
                                e.preventDefault();
                                if ($(this).attr('href') === '#tab-fiends' && self.friendList.length === 0) {
                                    self.getFriendList();
                                }
                            });
        ...
        _onFriendListGot: function (data) {
            ...
            /*
            <div class="kenshiin-friendList-container">
                <ul class="k-fl">
                    <li id="kfl-0" class="kfl-i">
                        <div class="kfl-i-wrap">
                            <div class="kfl-i-cover">
                                <img id="kfl-i-coverImage-USER_ID_HERE" class="kfl-i-coverImage" style="left:-2px; top:0px;" src="xxxx.jpg" height="266" alt="My Photo Tagged By Friends">
                            </div>
                            <div class="kfl-i-c">
                                <ul class="kfl-i-c-dt">
                                   <!-- dynamic add <li/> base on friend-data -->
                                    var result = {
                                        uid: value.uid,
                                        name: value.name,
                        ...
                        <div class="clearfix kenshiin-photoDetails">
                            <div class="kenshiin-photoText">
                                <a class="kenshiin-photoTextTitle" href="" target="_blank" title="visit on facebook page"> My Photo Tagged By Friends</a>
                                <div class="kenshiin-photoTextSubTitle">
                                    3 photos
                                <div class="kenshiin-albumAction">
                                <a id="kenshiin-albumActionSelectPhotos-fake_aid" class="kenshiin-albumActionSelectPhotos">select</a>
                                <a id="kenshiin-albumActionDownload-fake_aid" class="kenshiin-albumActionDownloadAlbum">download</a></div>
                            </div>
                                <div class="kenshiin-photoTextSelectedPhotos"></div>
                            </div>
                        </div>
                    </li>
                </ul>
            ...
            */
            ...
            //$('#tab-albums') === this.tpl.albumWrap
            $('#tab-friends').append(albumsActionWrap).append(albumList);
